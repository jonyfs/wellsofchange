...
export default function OurCommitment() {
  ...
  return (
    <section id="our-commitment" className="py-16 md:py-24 lg:py-32 bg-muted/30 overflow-hidden" ref={elementRef}>
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        <motion.h2 style={transform} className="font-display font-semibold text-3xl md:text-4xl lg:text-5xl mb-12 text-center" data-testid="text-commitment-title">
          {t("commitment.title")}
        </motion.h2>

        <motion.div style={transform} className="grid md:grid-cols-2 gap-8 mb-12">
        ...
        <motion.div style={transform} className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        ...
        <motion.div style={transform} className="max-w-4xl mx-auto space-y-6 text-base md:text-lg leading-relaxed">
