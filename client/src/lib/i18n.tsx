...
const translations: Record<Language, any> = {
  ...
  es: {
    ...
    whoWeAre: {
      ...
      communicationsDirectorBio: "Especialista en Marketing y Branding con amplia experiencia desde 2009, habiendo estructurado el área de Marketing y Branding de Intelie desde cero e integrado con Viasat tras la adquisición. Experta en proyectos de comunicación 360º, lanzamiento de nuevos productos y estrategia de marcas globales. Estudió Psicología Positiva para comprender cómo construir un mundo más pro-social y sostenible. Se unió a Wells of Change impulsada por el deseo de usar la creatividad y comunicación estratégica no solo para dialogar con las personas, sino para construir una marca que comprende su impacto en el mundo y participa activamente del cambio positivo, amplificando la misión de la organización de transformar vidas a través del acceso al agua potable.",
    },
    change: {
