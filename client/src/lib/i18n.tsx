...
const translations: Record<Language, any> = {
  en: {
    ...
    donate: {
      ...
      intlDescription: "Use these details at your bank to send from outside Brazil",
      labelSwift: "SWIFT / BIC",
      labelIban: "IBAN",
      labelBeneficiary: "Beneficiary",
      labelBeneficiaryAddress: "Beneficiary address",
      labelBankAddress: "Bank address",
      labelBranch: "Branch",
      intlFee: "Your bank may charge a transfer fee, and the amount arrives net of it.",
      intlHelp: "If your bank asks for something not listed here, write to wellsofchange@gmail.com.",
    ...
    whatWeDo: {
      ...
      motherDesc: "A family who can take care of hygiene with dignity.",
    ...
    change: {
      ...
      transform6: "Come be part of this change!",
  ...
  "pt-BR": {
    ...
    donate: {
      ...
      intlDescription: "Use estes dados no seu banco para enviar de fora do Brasil",
      labelSwift: "SWIFT / BIC",
      labelIban: "IBAN",
      labelBeneficiary: "Beneficiário",
      labelBeneficiaryAddress: "Endereço do beneficiário",
      labelBankAddress: "Endereço do banco",
      labelBranch: "Agência",
      intlFee: "Seu banco pode cobrar tarifa de remessa, e o valor chega descontado dela.",
      intlHelp: "Se o seu banco pedir algo que não está aqui, escreva para wellsofchange@gmail.com.",
    ...
    whatWeDo: {
      ...
      motherDesc: "Uma família que pode cuidar da higiene com dignidade.",
    ...
    change: {
      ...
      transform6: "Venha fazer parte desta mudança!",
      manifestoTitle: "WELLS OF CHANGE",
  ...
  es: {
    ...
    donate: {
      ...
      intlTitle: "Transferencia Internacional",
      intlDescription: "Usa estos datos en tu banco para enviar desde fuera de Brasil",
      labelSwift: "SWIFT / BIC",
      labelIban: "IBAN",
      labelBeneficiary: "Beneficiario",
      labelBeneficiaryAddress: "Dirección del beneficiario",
      labelBankAddress: "Dirección del banco",
      labelBranch: "Sucursal",
      intlFee: "Tu banco puede cobrar una comisión de envío, y el importe llega descontado de ella.",
      intlHelp: "Si tu banco pide algo que no figura aquí, escribe a wellsofchange@gmail.com.",
    ...
    whatWeDo: {
      ...
      motherDesc: "Una familia que puede cuidar la higiene con dignidad.",
    ...
    change: {
      ...
      transform6: "¡Ven a formar parte de este cambio!",
      manifestoTitle: "WELLS OF CHANGE",
  ...
  fr: {
    ...
    donate: {
      ...
      intlTitle: "Virement International",
      intlDescription: "Utilisez ces informations auprès de votre banque pour envoyer depuis l'étranger",
      labelSwift: "SWIFT / BIC",
      labelIban: "IBAN",
      labelBeneficiary: "Bénéficiaire",
      labelBeneficiaryAddress: "Adresse du bénéficiaire",
      labelBankAddress: "Adresse de la banque",
      labelBranch: "Agence",
      intlFee: "Votre banque peut prélever des frais de virement, et le montant arrive net de ces frais.",
      intlHelp: "Si votre banque demande un élément absent de cette liste, écrivez à wellsofchange@gmail.com.",
    ...
    whatWeDo: {
      ...
      motherDesc: "Une famille qui peut prendre soin de l'hygiène avec dignité.",
    ...
    change: {
      ...
      transform6: "Venez faire partie de ce changement !",
      manifestoTitle: "WELLS OF CHANGE",
