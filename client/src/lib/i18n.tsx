...
const translations: Record<Language, any> = {
  en: {
    ...
    whatWeDo: {
      ...
      tech1: "<strong>We drill the soil, install solar-powered pumps and apply real-time monitoring technology.</strong>",
      ...
      tech2: "<strong>With transparent data showing exactly how each dollar invested transforms into life.</strong>",
  ...
  "pt-BR": {
    ...
    whatWeDo: {
      ...
      tech1: "<strong>Nós perfuramos o solo, instalamos bombas movidas a energia solar e aplicamos tecnologia de monitoramento em tempo real.</strong>",
      ...
      tech2: "<strong>Com dados transparentes que mostram exatamente como cada real investido se transforma em vida.</strong>",
  ...
  es: {
    ...
    whatWeDo: {
      ...
      tech1: "<strong>Perforamos el suelo, instalamos bombas alimentadas por energía solar y aplicamos tecnología de monitoreo en tiempo real.</strong>",
      metricWater: "Cada gota",
      ...
      tech2: "<strong>Con datos transparentes que muestran exactamente cómo cada dólar invertido se transforma en vida.</strong>",
  ...
  fr: {
    ...
    whatWeDo: {
      ...
      tech1: "<strong>Nous forons le sol, installons des pompes alimentées par énergie solaire et appliquons une technologie de surveillance en temps réel.</strong>",
      ...
      tech2: "<strong>Avec des données transparentes montrant exactement comment chaque dollar investi se transforme en vie.</strong>",
