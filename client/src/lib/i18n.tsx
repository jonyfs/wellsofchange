...
const translations: Record<Language, any> = {
  en: {
    ...
    whoWeAre: {
      ...
      financialDirectorBio: "Financial management professional with extensive experience in strategic planning, budgeting, and fiscal transparency. Joined Wells of Change driven by the belief that financial integrity and accountability are essential to sustainable social impact. Her commitment to ensuring every donation is maximized for community benefit and her expertise in building transparent financial systems enable Wells of Change to operate with the highest standards of fiscal responsibility, turning resources into lasting change.",
    },
    ethics: {
  ...
  "pt-BR": {
    ...
    whoWeAre: {
      ...
      financialDirectorBio: "Profissional de gestão financeira com vasta experiência em planejamento estratégico, orçamento e transparência fiscal. Juntou-se à Wells of Change movida pela crença de que integridade financeira e responsabilidade são essenciais para impacto social sustentável. Seu compromisso em garantir que cada doação seja maximizada para o benefício da comunidade e sua expertise em construir sistemas financeiros transparentes permitem que a Wells of Change opere com os mais altos padrões de responsabilidade fiscal, transformando recursos em mudanças duradouras.",
    },
    change: {
  ...
  es: {
    ...
    whoWeAre: {
      ...
      financialDirectorBio: "Profesional de gestión financiera con amplia experiencia en planificación estratégica, presupuesto y transparencia fiscal. Se unió a Wells of Change impulsada por la creencia de que la integridad financiera y la rendición de cuentas son esenciales para el impacto social sostenible. Su compromiso de garantizar que cada donación se maximice para el beneficio de la comunidad y su experiencia en la construcción de sistemas financieros transparentes permiten que Wells of Change opere con los más altos estándares de responsabilidad fiscal, convirtiendo recursos en cambios duraderos.",
    },
    change: {
  ...
  fr: {
    ...
    whoWeAre: {
      ...
      financialDirectorBio: "Professionnelle de gestion financière avec une vaste expérience en planification stratégique, budgétisation et transparence fiscale. A rejoint Wells of Change motivée par la conviction que l'intégrité financière et la responsabilité sont essentielles à l'impact social durable. Son engagement à garantir que chaque don soit maximisé pour le bénéfice de la communauté et son expertise dans la construction de systèmes financiers transparents permettent à Wells of Change d'opérer avec les plus hauts standards de responsabilité fiscale, transformant les ressources en changements durables.",
    },
    change: {
