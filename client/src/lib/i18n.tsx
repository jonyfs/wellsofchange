...
const translations: Record<Language, any> = {
  en: {
    ...
    commitment: {
      ...
      reach: "From the Brazilian Northeast to Sub-Saharan Africa, we go where thirst is most urgent and hope seems most distant.",
    ...
    footer: {
      ...
      location: "Campo Formoso, Bahia, Brazil",
  ...
  "pt-BR": {
    ...
    commitment: {
      ...
      reach: "Do Nordeste brasileiro à África Subsaariana, vamos onde a sede é mais urgente e a esperança parece mais distante.",
    ...
    footer: {
      ...
      location: "Campo Formoso, Bahia, Brasil",
  ...
  es: {
    ...
    commitment: {
      ...
      reach: "Desde el Nordeste brasileño hasta el África Subsahariana, vamos donde la sed es más urgente y la esperanza parece más distante.",
    ...
    footer: {
      ...
      location: "Campo Formoso, Bahía, Brasil",
  ...
  fr: {
    ...
    commitment: {
      ...
      reach: "Du Nord-Est brésilien à l'Afrique subsaharienne, nous allons là où la soif est la plus urgente et l'espoir semble le plus lointain.",
    ...
    footer: {
      ...
      location: "Campo Formoso, Bahia, Brésil",
